...
MuJoCo一般用于约束刚体的仿真。系统状态定义在关节广义坐标系中，刚体被组织成[运动链](https://zhuanlan.zhihu.com/p/374121872)。除了worldbody外其他刚体都只有一个父节点，并且运动环结构的定义不被允许。如果想要定义闭环结构话，需要通过equalityequalityequality属性来定义环关节。
