...
- [OpenRLHF源码解读](aigc/llm_rlhf/OpenRLHF源码解读.md)
- [从Ray角度分析OpenRLHF和Verl的工程设计](aigc/llm_rlhf/从Ray角度分析OpenRLHF和Verl的工程设计.md)
- [DeepSeek-R1：通过强化学习激励LLMs的推理能力](aigc/llm_rlhf/DeepSeek-R1.md)
- [DAPO: 一个开源的大规模LLM强化学习系统](aigc/llm_rlhf/DAPO.md)
- [DeepSpeed-Chat](aigc/llm_rlhf/DeepSpeed-Chat.md)
- [Kimi k1.5：使用LLM扩展强化学习](aigc/llm_rlhf/Kimi_k1.5.md)
- [KL散度的近似计算](aigc/llm_rlhf/KL-Approximate.md)
- [NeMo-Aligner：用于高效模型对齐的可扩展工具包](aigc/llm_rlhf/NeMo-Aligner.md)
- [OpenR: 一个用于增强大语言模型推理能力的开源框架](aigc/llm_rlhf/OpenR.md)
- [OpenRLHF源码解读](aigc/llm_rlhf/OpenRLHF源码解读.md)
...
- [REINFORCE++：一种简单高效的大型语言模型对齐方法](aigc/llm_rlhf/REINFORCE++.md)
- [拒绝采样（Reject Sampling）在RLHF中的应用](aigc/llm_rlhf/RejectSampling.md)
- [ReST-MCTS：通过过程奖励引导的树搜索实现LLM自训练](aigc/llm_rlhf/ReST-MCTS.md)
